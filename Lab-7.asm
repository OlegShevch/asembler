...
dataseg
    ...
    message_1 db "n - for count", 13, 10, '$'
    message_2 db "M - for beep", 13, 10, '$'
    message_3 db ", - for exit", 13, 10, '$' 
    message_3_0 db "r - for min value", 13, 10, '$' 
